...
def run_training_pipeline(
    ...
    def train(part):
        ...
        if part == "Part_1":
            ...
            command = f"sh /work3/s174159/LLM_Thesis/SOTA/DREEAM/training/3.sh '3_{dataset_name.replace(' ', '_')}_SelfTrain' {teacher_ckpt_dir} {lambda_val} {seed_val} {student_save_path} {meta_dir} {data_dir} {num_class} {epochs} {lr} {max_grad_norm}"
        elif part == "Part_4":
            ...
            command = f"sh /work3/s174159/LLM_Thesis/SOTA/DREEAM/training/4.sh '4_{dataset_name.replace(' ', '_')}_FineTune' {student_ckpt_dir} {lambda_val} {seed_val} {student_save_path} {meta_dir} {data_dir} {num_class} {epochs} {lr} {max_grad_norm}"
...
if __name__ == "__main__":
    ...
    local_config_path = "/work3/s174159/LLM_Thesis/SOTA/DREEAM/training/config/BERT_Combined_Default.yml"
